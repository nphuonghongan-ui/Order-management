...
description: "Skill for the Container-viewer area of Order-management. 29 symbols across 9 files."
---

# Container-viewer

29 symbols | 9 files | Cohesion: 81%

## When to Use

- Working with code in `frontend/`
- Understanding how formatNumber, QtyCell, Toolbar work
...
| File | Symbols |
|------|---------|
| `frontend/src/components/container-viewer/Toolbar.tsx` | Section, Toolbar, setAxisConstraint, setSpace, setView (+5) |
...
| `Section` | Function | `frontend/src/components/container-viewer/Toolbar.tsx` | 53 |
