---
name: po
description: "Skill for the Po area of Order-management. 26 symbols across 11 files."
---

# Po

26 symbols | 11 files | Cohesion: 70%
...
| `Field` | Function | `frontend/src/components/po/Field.tsx` | 3 |
...
| `render` | Function | `frontend/src/components/packing-list/ItemPicker.tsx` | 245 |
| `sortValue` | Function | `frontend/src/components/packing-list/ItemPicker.tsx` | 251 |
