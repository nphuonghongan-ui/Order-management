...
This project is indexed by GitNexus as **Order-management** (1059 symbols, 2354 relationships, 85 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
