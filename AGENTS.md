...
This project is indexed by GitNexus as **Order-management** (752 symbols, 1615 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
