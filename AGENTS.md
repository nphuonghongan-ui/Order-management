...
This project is indexed by GitNexus as **Order-management** (417 symbols, 772 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
