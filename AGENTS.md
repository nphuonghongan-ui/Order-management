...
This project is indexed by GitNexus as **Order-management** (1372 symbols, 3086 relationships, 111 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Pages area (109 symbols) | `.claude/skills/generated/pages/SKILL.md` |
| Work in the Ui area (99 symbols) | `.claude/skills/generated/ui/SKILL.md` |
| Work in the Container-viewer area (60 symbols) | `.claude/skills/generated/container-viewer/SKILL.md` |
| Work in the Controllers area (56 symbols) | `.claude/skills/generated/controllers/SKILL.md` |
| Work in the Packing-list area (37 symbols) | `.claude/skills/generated/packing-list/SKILL.md` |
| Work in the Apis area (18 symbols) | `.claude/skills/generated/apis/SKILL.md` |
| Work in the Po area (15 symbols) | `.claude/skills/generated/po/SKILL.md` |
