...
This project is indexed by GitNexus as **Order-management** (371 symbols, 651 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
