...
This project is indexed by GitNexus as **Order-management** (1164 symbols, 2617 relationships, 93 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Ui area (112 symbols) | `.claude/skills/generated/ui/SKILL.md` |
| Work in the Pages area (78 symbols) | `.claude/skills/generated/pages/SKILL.md` |
