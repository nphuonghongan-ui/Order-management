...
This project is indexed by GitNexus as **Order-management** (1168 symbols, 2620 relationships, 93 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
