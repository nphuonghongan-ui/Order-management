...
This project is indexed by GitNexus as **Order-management** (1741 symbols, 3853 relationships, 142 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Controllers area (77 symbols) | `.claude/skills/generated/controllers/SKILL.md` |
| Work in the Pages area (77 symbols) | `.claude/skills/generated/pages/SKILL.md` |
...
| Work in the Oauth area (19 symbols) | `.claude/skills/generated/oauth/SKILL.md` |
...
| Work in the Google area (5 symbols) | `.claude/skills/generated/google/SKILL.md` |
