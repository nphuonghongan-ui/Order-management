...
This project is indexed by GitNexus as **Order-management** (1408 symbols, 3171 relationships, 114 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Ui area (91 symbols) | `.claude/skills/generated/ui/SKILL.md` |
...
| Work in the Stores area (18 symbols) | `.claude/skills/generated/stores/SKILL.md` |
