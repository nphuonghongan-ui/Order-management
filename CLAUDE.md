...
This project is indexed by GitNexus as **Order-management** (185 symbols, 398 relationships, 13 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
