...
This project is indexed by GitNexus as **Order-management** (446 symbols, 836 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
