...
This project is indexed by GitNexus as **Order-management** (1053 symbols, 2328 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
