...
This project is indexed by GitNexus as **Order-management** (1007 symbols, 2228 relationships, 81 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
