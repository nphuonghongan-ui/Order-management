      ...
      schemas: {
        ...
        YardPublic: {
          ...
          properties: {
            ...
            totalCols: { type: 'integer' },
            defaultMaxTier: { type: 'integer' },
            blocks: {
              type: 'array',
              items: { $ref: '#/components/schemas/YardBlockPublic' },
            },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' },
          },
        ...
        YardContainerPublic: {
          ...
          properties: {
            ...
            currentSlotId: { type: 'string', nullable: true },
            notes: { type: 'string' },
            createdAt: { type: 'string', format: 'date-time' },
            updatedAt: { type: 'string', format: 'date-time' },
          },
        ...
        SlotPublic: {
          ...
          properties: {
            ...
            yardContainerId: { type: 'string', nullable: true },
            isReserved: { type: 'boolean' },
            container: {
              nullable: true,
              $ref: '#/components/schemas/YardContainerPublic',
            },
          },
        },
        YardLayoutResponse: {
          type: 'object',
          properties: {
            yard: { $ref: '#/components/schemas/YardPublic' },
            slots: {
              type: 'array',
